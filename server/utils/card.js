class Card{
    ...
    getComboScore(cards){
        ...
        if (this.isFlush(cards)){
            if(this.getCardImage(cards)[0] === "D") return (2000 + Math.max.apply(null, this.getCardValue(cards)));
            if(this.getCardImage(cards)[0] === "C") return (2250 + Math.max.apply(null, this.getCardValue(cards)));
